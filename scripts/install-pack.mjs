...
if (!new Set(["full", "machines", "commands", "terrain", "arbitrary", "portal", "travel-rollback", "local-travel", "city", "child", "refinement", "feedback", "farms", "kelp", "delivery", "offline-gift"]).has(e2eScope)) {
  throw new Error("MC_WIZARD_E2E_SCOPE must be full, machines, commands, terrain, arbitrary, portal, travel-rollback, local-travel, city, child, refinement, feedback, farms, kelp, delivery, or offline-gift");
}
