...
- The Node/static suite passes 265 tests. Headless Bedrock scopes cover chat transport, player embodiment, machines, arbitrary structures, child-facing builds, refinements, farms, portals, city goal/refinement behavior, and injected partial-travel rollback with a two-child party plus the visible Wizard.
...
- The simulated player's custom skin is client-sensitive and still needs reliable join/rejoin acceptance across iPad clients.
