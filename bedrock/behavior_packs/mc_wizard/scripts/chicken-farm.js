...
export function createAutomaticChickenFarmBlueprint() {
  ...
  return {
    ...
    success: "Chicken farm ready! The four chickens lay eggs onto the hopper, and the hopper moves every egg into the chest. Open the chest at the front to collect them.",
